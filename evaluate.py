"""
ML Mirchi — Model Evaluation
Computes all metrics from the project spec: Accuracy, Precision, Recall, F1, Latency.
Also generates confusion matrix and per-class analysis.
"""
